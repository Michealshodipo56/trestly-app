...
exports.wrapX402Payment = wrapX402Payment;
 ...
 * ```
 */
async function wrapX402Payment(config, params) {
    ...
    return (0, client_js_1.createPayment)(config, {
        payer: params.payer,
        payee: params.payee,
        token: params.token,
...
//# sourceMappingURL=x402-wrapper.js.map