 ...
 * ```
 */
export declare function wrapX402Payment(config: TrestlyConfig, params: X402PaymentParams): Promise<CreatePaymentResult>;
//# sourceMappingURL=x402-wrapper.d.ts.map